...
<%!//
	...
	void Search_Show(javax.servlet.http.HttpServletRequest request,
		...
		try {
			...
			out
					.println("     <form method=\"get\" action=\"AdminBooks.jsp\" name=\"Search\">\n     <tr>");
			...
			out
					.println("      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Recommended</font></td>");
			out
					.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
			out.print("<select name=\"is_recommended\">"
					+ getOptionsLOV(";All;0;No;1;Yes", true, false,
							fldis_recommended) + "</select>");
			out.println("</td>");

			out
					.println("      <td ><input type=\"submit\" value=\"Search\"/></td>");
			out.println("     </tr>\n     </form>\n    </table>");
			out.println("");
		} catch (Exception e) {
	...
	void Items_Show(javax.servlet.http.HttpServletRequest request,
		...
		transitParams = "category_id="
				+ toURL(getParam(request, "category_id")) + "&is_recommended="
				+ toURL(getParam(request, "is_recommended")) + "&";
		...
		if (iSort == 0) {
			...
			if (sSort.equals(sSorted)) {
				...
				sForm_Sorting = "";
				sDirection = " DESC";
				sSortParams = "FormItems_Sorting=" + sSort
						+ "&FormItems_Sorted=" + sSort + "&";
			} else {
				sSorted = sSort;
				sForm_Sorting = sSort;
				sDirection = " ASC";
			...
			if (iSort == 5) {
				sOrder = " order by i.is_recommended" + sDirection;
			}
		}
		...
		sSQL = "select i.author as i_author, "
				...
				+ "i.price as i_price, " + "c.category_id as c_category_id, "
				+ "c.name as c_name " + " from items i, categories c"
		...
		tableHeader = "     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a &\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Edit</font></a></td>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				...
				+ "?"
				+ formParams
				+ "FormItems_Sorting=1&FormItems_Sorted="
				+ sSorted
				+ "&\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Title</font></a></td>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				+ sFileName
				+ "?"
				+ formParams
				+ "FormItems_Sorting=2&FormItems_Sorted="
				+ sSorted
				+ "&\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Author</font></a></td>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				+ sFileName
				+ "?"
				+ formParams
				+ "FormItems_Sorting=3&FormItems_Sorted="
				+ sSorted
				+ "&\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Price</font></a></td>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				+ sFileName
				+ "?"
				+ formParams
				+ "FormItems_Sorting=4&FormItems_Sorted="
				+ sSorted
				+ "&\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Category</font></a></td>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				+ sFileName
				+ "?"
				+ formParams
				+ "FormItems_Sorting=5&FormItems_Sorted="
				+ sSorted
				+ "&\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Recommended</font></a></td>\n     </tr>";
		...
		try {
			...
			while ((iCounter < RecordsPerPage) && rs.next()) {
				...
				String fldis_recommended = (String) rsHash
						.get("i_is_recommended");
				...
				out
						.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
				fldis_recommended = getValFromLOV(fldis_recommended,
						"0;No;1;Yes");
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
						+ toHTML(fldis_recommended) + "&nbsp;</font>");
				out.println("</td>");
				out.println("     </tr>");
			...
			if (iCounter == 0) {
				...
				out
						.print("<a href=\"BookMaint.jsp?"
								+ formParams
								+ "\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Add New</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.println("</td>\n     </tr>");
