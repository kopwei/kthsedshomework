...
<%!String CategoriesAction(javax.servlet.http.HttpServletRequest request,
		...
		try {
			...
			case iupdateAction:
				...
				sSQL = "update categories set " + "name="
	...
	void Categories_Show(javax.servlet.http.HttpServletRequest request,
		...
		try {
			...
			primaryKeyParams += "<input type=\"hidden\" name=\"PK_category_id\" value=\""
					+ pcategory_id + "\"/>";
			...
			if (bPK
					&& !(sAction.equals("insert") && "Categories".equals(sForm))) {
			...
			if (bPK
					&& !(sAction.equals("insert") && "Categories".equals(sForm))) {
				out
						.print("<input type=\"submit\" value=\"Update\" onclick=\"document.Categories.FormAction.value = 'update';\">");
				out
						.print("<input type=\"submit\" value=\"Delete\" onclick=\"document.Categories.FormAction.value = 'delete';\">");
				out
						.print("<input type=\"submit\" value=\"Cancel\" onclick=\"document.Categories.FormAction.value = 'cancel';\">");
				out
						.print("<input type=\"hidden\" name=\"FormName\" value=\"Categories\"><input type=\"hidden\" value=\"update\" name=\"FormAction\">");
			}

			else {
				out
						.print("<input type=\"submit\" value=\"Insert\" onclick=\"document.Categories.FormAction.value = 'insert';\">");
				out
						.print("<input type=\"submit\" value=\"Cancel\" onclick=\"document.Categories.FormAction.value = 'cancel';\">");
				out
						.print("<input type=\"hidden\" name=\"FormName\" value=\"Categories\"><input type=\"hidden\" value=\"insert\" name=\"FormAction\">");
			}
			out.print("<input type=\"hidden\" name=\"category_id\" value=\""
					+ toHTML(fldcategory_id) + "\">");
...
<%
	...
	if (sForm.equals("Categories")) {
		sCategoriesErr = CategoriesAction(request, response, session,
