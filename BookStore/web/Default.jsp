...
<%!void Search_Show(javax.servlet.http.HttpServletRequest request,
			...
			javax.servlet.jsp.JspWriter out, String sSearchErr, String sForm,
		...
		try {
			...
			out
					.println("     <form method=\"get\" action=\"Books.jsp\" name=\"Search\">\n     <tr>");
			...
			out
					.println("      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Category</font></td>");
			out
			...
			out
					.print("<select name=\"category_id\">"
							+ getOptions(
									...
									true, false, fldcategory_id) + "</select>");
			out.println("</td>\n     </tr>\n     <tr>");

			out
					.println("      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Title</font></td>");
			out
					.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
			out
					.print("<input type=\"text\"  name=\"name\" maxlength=\"10\" value=\""
							+ toHTML(fldname) + "\" size=\"10\">");
			out.println("</td>\n     </tr>\n     <tr>");

			out
					.println("      <td align=\"right\" colspan=\"3\"><input type=\"submit\" value=\"Search\"/></td>");
			out.println("     </tr>\n     </form>\n    </table>");
			out.println("");
		} catch (Exception e) {
	...
	void AdvMenu_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sAdvMenuErr, String sForm,
			String sAction, java.sql.Connection conn, java.sql.Statement stat)
			throws java.io.IOException {
		try {
			...
			out
					.print("\n      <td style=\"background-color: #FFFFFF; border-width: 1\"><a href=\""
							+ fldField1
							+ "\"><font style=\"font-size: 10pt; color: #000000\">Advanced search</font></a></td>");
	...
	void Recommended_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sRecommendedErr,
		...
		if (iSort == 0) {
			...
			if (sSort.equals(sSorted)) {
				...
				sForm_Sorting = "";
				sDirection = " DESC";
				sSortParams = "FormRecommended_Sorting=" + sSort
						+ "&FormRecommended_Sorted=" + sSort + "&";
			} else {
				sSorted = sSort;
				sForm_Sorting = sSort;
				sDirection = " ASC";
				sSortParams = "FormRecommended_Sorting=" + sSort
						+ "&FormRecommended_Sorted=" + "&";
			}
		...
		sSQL = "select i.author as i_author, " + "i.image_url as i_image_url, "
				+ "i.item_id as i_item_id, " + "i.name as i_name, "
				+ "i.price as i_price " + " from items i ";
		...
		try {
			...
			while ((iCounter < RecordsPerPage) && rs.next()) {
				...
				out
						.print("<a href=\"BookDetail.jsp?"
								+ transitParams
								+ "item_id="
								+ toURL((String) rsHash.get("i_item_id"))
								+ "&\"><font style=\"font-size: 10pt; color: #000000\">"
								+ toHTML(fldname) + "</font></a>");
				...
				out.println("</td>\n     </tr>");
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Price</font> </td></tr><tr><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
	...
	void What_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sWhatErr, String sForm,
			String sAction, java.sql.Connection conn, java.sql.Statement stat)
			throws java.io.IOException {
		...
		sSQL = "select e.article_desc as e_article_desc, "
				...
				+ "e.item_id as e_item_id, " + "i.item_id as i_item_id, "
				+ "i.image_url as i_image_url " + " from editorials e, items i"
		...
		try {
			...
			while (rs.next()) {
				...
				String fldarticle_title = (String) rsHash
						.get("e_article_title");
				...
				out
						.print("<a href=\"BookDetail.jsp?"
								+ transitParams
								+ "item_id="
								+ toURL((String) rsHash.get("e_item_id"))
								+ "&\"><font style=\"font-size: 10pt; color: #000000\">"
								+ toHTML(fldarticle_title) + "</font></a>");

				out.println("</td>\n     </tr>");
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\"></font> </td></tr><tr><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
						+ fldarticle_desc + "&nbsp;</font>");
				out.println("</td>\n     </tr>");
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\"></font> </td></tr><tr><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out
	...
	void Categories_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sCategoriesErr,
			String sForm, String sAction, java.sql.Connection conn,
			java.sql.Statement stat) throws java.io.IOException {
		...
		sSQL = "select c.category_id as c_category_id, " + "c.name as c_name "
				+ " from categories c ";
		...
		try {
			...
			while (rs.next()) {
				...
				out
						.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
				out
						.print("<a href=\"Books.jsp?"
								+ transitParams
								+ "category_id="
								+ toURL((String) rsHash.get("c_category_id"))
								+ "&\"><font style=\"font-size: 10pt; color: #000000\">"
								+ toHTML(fldname) + "</font></a>");
	...
	void New_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sNewErr, String sForm,
			String sAction, java.sql.Connection conn, java.sql.Statement stat)
			throws java.io.IOException {
	...
	void Weekly_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sWeeklyErr, String sForm,
			String sAction, java.sql.Connection conn, java.sql.Statement stat)
			throws java.io.IOException {
	...
	void Specials_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sSpecialsErr, String sForm,
			String sAction, java.sql.Connection conn, java.sql.Statement stat)
			throws java.io.IOException {
		...
		sSQL = "select e.article_desc as e_article_desc, "
				+ "e.article_title as e_article_title " + " from editorials e ";
		...
		<table>
			<tr>
				<td valign="top">
					...
					<%
						AdvMenu_Show(request, response, session, out, sAdvMenuErr, sForm,
								sAction, conn, stat);
					%>

					<%
						Categories_Show(request, response, session, out, sCategoriesErr,
								sForm, sAction, conn, stat);
					%>

					<%
						Specials_Show(request, response, session, out, sSpecialsErr, sForm,
								sAction, conn, stat);
					%>
				</td>
				<td valign="top">
					...
					<%
						Recommended_Show(request, response, session, out, sRecommendedErr,
								sForm, sAction, conn, stat);
					%>
				</td>
				<td valign="top">
					<%
						What_Show(request, response, session, out, sWhatErr, sForm,
								sAction, conn, stat);
					%>

					<%
						New_Show(request, response, session, out, sNewErr, sForm, sAction,
								conn, stat);
					%>

					<%
						Weekly_Show(request, response, session, out, sWeeklyErr, sForm,
								sAction, conn, stat);
					%>
