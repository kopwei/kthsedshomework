...
<%!void editorials_Show(javax.servlet.http.HttpServletRequest request,
		...
		if (iSort == 0) {
			...
			if (sSort.equals(sSorted)) {
				...
				sForm_Sorting = "";
				sDirection = " DESC";
				sSortParams = "Formeditorials_Sorting=" + sSort
						+ "&Formeditorials_Sorted=" + sSort + "&";
			} else {
				sSorted = sSort;
				sForm_Sorting = sSort;
				sDirection = " ASC";
				sSortParams = "Formeditorials_Sorting=" + sSort
						+ "&Formeditorials_Sorted=" + "&";
			}
		...
		try {
			...
			while ((iCounter < RecordsPerPage) && rs.next()) {
				...
				out
						.print("<a href=\"EditorialsRecord.jsp?"
								+ transitParams
								+ "article_id="
				...
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
						+ toHTML(fldeditorial_cat_id) + "&nbsp;</font>");
				out.println("</td>");
				out
						.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
