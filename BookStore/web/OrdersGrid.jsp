...
<%!void Search_Show(javax.servlet.http.HttpServletRequest request,
		...
		try {
			...
			out
					.println("     <form method=\"get\" action=\"OrdersGrid.jsp\" name=\"Search\">\n     <tr>");
			...
			out
					.println("      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Item</font></td>");
			out
					.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
			out.print("<select name=\"item_id\">"
					+ getOptions(conn,
							"select item_id, name from items order by 2", true,
							false, flditem_id) + "</select>");
			out.println("</td>");

			out
					.println("      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Member</font></td>");
			out
					.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
			out
					.print("<select name=\"member_id\">"
							+ getOptions(
									...
									true, false, fldmember_id) + "</select>");
			out.println("</td>");
	...
	void Orders_Show(javax.servlet.http.HttpServletRequest request,
		...
		transitParams = "item_id=" + toURL(getParam(request, "item_id"))
				+ "&member_id=" + toURL(getParam(request, "member_id")) + "&";
		formParams = "item_id=" + toURL(getParam(request, "item_id"))
				+ "&member_id=" + toURL(getParam(request, "member_id")) + "&";
		...
		sSQL = "select o.item_id as o_item_id, "
				...
				+ "i.name as i_name, " + "m.member_id as m_member_id, "
		...
		tableHeader = "     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a &\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Edit</font></a></td>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				...
				+ sSorted
				+ "&\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Member</font></a></td>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				+ sFileName
				+ "?"
				+ formParams
