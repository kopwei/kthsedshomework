...
<%!void Results_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sResultsErr, String sForm,
		...
		transitParams = "category_id="
				+ toURL(getParam(request, "category_id")) + "&name="
				+ toURL(getParam(request, "name")) + "&pricemin="
				+ toURL(getParam(request, "pricemin")) + "&pricemax="
				+ toURL(getParam(request, "pricemax")) + "&author="
				+ toURL(getParam(request, "author")) + "&";
		formParams = "category_id=" + toURL(getParam(request, "category_id"))
				+ "&name=" + toURL(getParam(request, "name")) + "&pricemin="
				+ toURL(getParam(request, "pricemin")) + "&pricemax="
				+ toURL(getParam(request, "pricemax")) + "&author="
				+ toURL(getParam(request, "author")) + "&";
		...
		if (iSort == 0) {
			...
			if (sSort.equals(sSorted)) {
				...
				sForm_Sorting = "";
				sDirection = " DESC";
				sSortParams = "FormResults_Sorting=" + sSort
						+ "&FormResults_Sorted=" + sSort + "&";
			} else {
				sSorted = sSort;
				sForm_Sorting = sSort;
				sDirection = " ASC";
		...
		sSQL = "select i.author as i_author, "
				...
				+ "i.image_url as i_image_url, " + "i.item_id as i_item_id, "
				+ "i.name as i_name, " + "i.price as i_price, "
		...
		try {
			...
			while ((iCounter < RecordsPerPage) && rs.next()) {
				...
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Title</font> </td><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out
				...
				out.println("</td>\n     </tr>");
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Author</font> </td><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
						+ toHTML(fldauthor) + "&nbsp;</font>");
				out.println("</td>\n     </tr>");
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Price</font> </td><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
						+ toHTML(fldprice) + "&nbsp;</font>");
				out.println("</td>\n     </tr>");
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Category</font> </td><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out.print("<font style=\"font-size: 10pt; color: #000000\">"
						+ toHTML(fldcategory_id) + "&nbsp;</font>");
				out.println("</td>\n     </tr>");
				out
						.print("     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Image URL</font> </td><td style=\"background-color: #FFFFFF; border-width: 1\">");
				out
						.print("<a href=\"BookDetail.jsp?"
								+ transitParams
								+ "item_id="
	...
	void Total_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sTotalErr, String sForm,
			String sAction, java.sql.Connection conn, java.sql.Statement stat)
			throws java.io.IOException {
		...
		formParams = "category_id=" + toURL(getParam(request, "category_id"))
				+ "&name=" + toURL(getParam(request, "name")) + "&author="
				+ toURL(getParam(request, "author")) + "&pricemin="
				+ toURL(getParam(request, "pricemin")) + "&pricemax="
				+ toURL(getParam(request, "pricemax")) + "&";
		// Build WHERE statement
	...
	<body
		...
		<table> 
			<tr> 
				<td valign="top"> 
					<% 
						Total_Show(request, response, session, out, sTotalErr, sForm, 
								sAction, conn, stat); 
					%> 
		...
		<table> 
			<tr> 
				<td valign="top"> 
					<% 
						Results_Show(request, response, session, out, sResultsErr, sForm, 
								sAction, conn, stat); 
					%> 
