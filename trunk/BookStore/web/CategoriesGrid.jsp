...
<%!void Categories_Show(javax.servlet.http.HttpServletRequest request,
		...
		if (iSort == 0) {
			...
			if (sSort.equals(sSorted)) {
				...
				sForm_Sorting = "";
				sDirection = " DESC";
				sSortParams = "FormCategories_Sorting=" + sSort
						+ "&FormCategories_Sorted=" + sSort + "&";
			} else {
				sSorted = sSort;
				sForm_Sorting = sSort;
				sDirection = " ASC";
				sSortParams = "FormCategories_Sorting=" + sSort
						+ "&FormCategories_Sorted=" + "&";
			}
		...
		tableHeader = "     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""
				...
				+ "?"
				+ formParams
				+ "FormCategories_Sorting=1&FormCategories_Sorted="
				+ sSorted
		...
		try {
			...
			while ((iCounter < RecordsPerPage) && rs.next()) {
				...
				out
						.print("<a href=\"CategoriesRecord.jsp?"
								+ transitParams
								+ "category_id="
