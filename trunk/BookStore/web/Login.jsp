...
<%
	...
	if (sForm.equals("Login")) {
		sLoginErr = LoginAction(request, response, session, out,
...
String LoginAction(javax.servlet.http.HttpServletRequest request,
	...
	void Login_Show(javax.servlet.http.HttpServletRequest request,
			javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session,
			javax.servlet.jsp.JspWriter out, String sLoginErr, String sForm,
		...
		try {
			...
			if (session.getAttribute("UserID") == null
				...
				// User did not login
				out
						.println("     <tr>\n      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Login</font></td><td style=\"background-color: #FFFFFF; border-width: 1\"><input type=\"text\" name=\"Login\" maxlength=\"50\" value=\""
								+ toHTML(getParam(request, "Login"))
								+ "\"></td>\n     </tr>");
				out
				...
				out
						.print("     <tr><td style=\"background-color: #FFFFFF; border-width: 1\"><font style=\"font-size: 10pt; color: #000000\">"
								+ sUserID
								+ "&nbsp;&nbsp;"
								+ "</font><input type=\"hidden\" name=\"FormAction\" value=\"logout\"/><input type=\"submit\" value=\"Logout\"/>");
				out
		...
		<jsp:include page="Header.jsp" flush="true" /><center>
			<table>
				<tr>
					...
					<td valign="top">
						<%
							Login_Show(request, response, session, out, sLoginErr, sForm,
									sAction, conn, stat);
						%>
						guest/guest
						<br>
