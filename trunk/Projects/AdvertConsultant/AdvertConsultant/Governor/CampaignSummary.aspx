<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampaignSummary.aspx.cs" Inherits="AdvertConsultant.Governor.CampaignSummary" MasterPageFile="../SiteMaster.master"%>
...
<br />
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        BorderWidth="1px" CellPadding="4" DataKeyNames="CampaignID" DataSourceID="CampaignDataSource1">
    ...
    <asp:ObjectDataSource ID="CampaignDataSource1" runat="server" DeleteMethod="Delete"
        InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetCampaignSummaryDataByInNegotiation"
        TypeName="AdvertConsultant.DataSets.CampaignTableAdapters.CampaignsTableAdapter" UpdateMethod="Update">
        <DeleteParameters>
